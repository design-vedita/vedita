       ...
       /*-----------------preloader--------------------*/
        ...
        function setClient(max, menu, client_height, client_width) {
            ...
            if (client_height < max) {
                ...
                /**
                 * ≈сли высота окна больше максильмальной высоты submenu, то значение высоты правого блока меню и меню = высоте клиента
                ...
                /*
                 * ” больших экранов делаем левый блок top 0, чтобы не убегал вниз, иначе его делам под правым блоком
                ...
                /**
                 * »наче правый равен высоте максимального, а само меню клиенту (подт€гиваем до размера экрана)
                ...
                /**
                 * ” больших экранов делаем левый блок высотой по максимальному submenu, иначе по высоте клиента
        ...
        function getOffsetRect(elem) {
            /**
             *   ѕолучаем отступ сверху и слева дл€ элемента
        ...
        for (var i = 0; i < submenu_li.length; i++) {
            ...
            /**
             * ¬ массив получаем точную координату нижнего угла дл€ каждого submenu, это нам даЄт пон€ть, насколько ниже нашей области просмотра может быть выпадающее меню.
             * ƒобавл€ем 2000, т.к. на "-" это рассто€ние мы пр€чем наше меню и также добавл€ем высоту нашего submenu
             *
